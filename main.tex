...
\ThesisSetTitle{Bridging LLM Detection and Authorship Verification: Revisiting the Impostors Method}
...
\begin{frontmatter}
    ...
    \include{chapter/section-03/03-llm-detection}
    \include{chapter/section-04/04-llm-based-impostor-method} 
    \include{chapter/section-05/05-paraphrase-evaluation} % ggf experimente setup extra/ oder extra + datensätze + exp+ analyse (Tabelle)
    \include{chapter/section-06/06-dataset-experimental-setup}
    \include{chapter/section-07/07-experimental-results}
    \include{chapter/section-08/08-discussion}
    \include{chapter/section-09/09-conclusion}
    % \chapter{Notes}
    % % notes
