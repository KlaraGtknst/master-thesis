...
\begin{document}
    ...
    % notes; using input to avoid pagebreaks
    \input{notes/PAN_definition}
    \input{notes/PAN_authorship_verification}
    \input{notes/PAN_dataset_autorship_verification}
    \input{notes/PAN24_evaluation}
