...
We first introduce the main classification concepts relevant to \ac{aa} and \ac{av} in \Cref{subsec:ml_principles}. 
In \Cref{subsec:train_test}, we then discuss training and evaluation practices, including domain shift scenarios. 
Finally, in \Cref{subsec:attribution_methods}, we present the principal categories of authorship analysis.
