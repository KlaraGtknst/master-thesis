...
Stylometric features, organized into broad categories in \Cref{tab:stylometric_features}, span from lexical and character statistics to semantic and application-specific indicators, with the latter often being noisier due to reliance on processing tools~\citep{stamatatos_survey_2009}.
