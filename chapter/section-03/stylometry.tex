...
Stylometric features, broadly organised into categories in \Cref{tab:stylometric_features}, span from lexical and character statistics to semantic and application-specific indicators.
