...
Distributions over character $n$-grams counts, word-length~\citep{stein_intrinsic_2011}, and sentence-length~\citep{stein_intrinsic_2011,abbasi_writeprints_2008} are classic for character, word, and sentence unit-based lexical features that disregard token order in the \ac{bow} fashion~\citep{neal_surveying_2018}, respectively. 
