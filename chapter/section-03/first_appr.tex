...
For instance, \citet{bertaa_2020} observed that their fine-tuned \acs{bert} model achieved improved effectivity when its class probability outputs were combined with those of a stylometric classifier.
