...
This category of approaches relies on general-purpose compression models, such as RAR or \ac{ppmd}. %(i.e. a variant of \ac{ppm}~\citep{tyo_state_2022}), LZW, GZIP, BZIP2 and 7ZIP.
