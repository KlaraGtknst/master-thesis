...
This category of approaches relies on general-purpose compression models, such as \ac{rar}~\citep{rar_2004} or \ac{ppmd}~\citep{ppm_2001}. %(i.e.\ a variant of \ac{ppm}~\citep{tyo_state_2022}), LZW, GZIP, BZIP2 and 7ZIP.
