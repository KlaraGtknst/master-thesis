...
We begin with the foundational problems of \ac{aa} in \Cref{subsec:def_aa} and \ac{av} in \Cref{subsec:def_av}, before turning to derivative tasks such as \ac{llm} detection in \Cref{subsec:def_llm_detection}.
...
Formally, the \ac{aa} task aims to learn the function defined in \Cref{eq:authorship_attribution_function}.
...
The goal of the \ac{av} task is to learn the function specified in \Cref{eq:authorship_verification_function}.
...
\label{subsec:def_llm_detection}
