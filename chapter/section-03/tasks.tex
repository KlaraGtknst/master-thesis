...
We begin with the foundational problems of \ac{aa} in \Cref{subsec:def_aa} and \ac{av} in \Cref{subsec:def_av}, before turning to related tasks such as \ac{llm} detection in \Cref{subsec:def_llm_detection}.
