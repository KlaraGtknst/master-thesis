...
The thesis extends the \impAppr{} by leveraging \acl{sota} \acp{llm} to generate paraphrases as \imps{}, enabling simultaneous control over multiple confounding factors such as genre, topic, and target audience. 
