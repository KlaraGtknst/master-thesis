...
By integrating \ac{llm}-based \imp{} generation, we leverage \acp{llm} to extend a traditional \ac{av} method. 
The contribution lies not in proposing a new detection paradigm, but in enhancing an established \ac{av} method by improving its treatment of contextual factors and strengthening its ability to discriminate between genuine and artificial authorship.
