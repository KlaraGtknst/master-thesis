...
\begin{itemize}
    ...
    \item The proposed \ac{llm}-based \impAppr{} was evaluated against established \ac{av} techniques, namely \unmasking{} and PPMD across different scenarios (cf. \autoref{sec:results_trad_av} and \autoref{sec:results_llm_av}/ \ref{enum:rq3})
