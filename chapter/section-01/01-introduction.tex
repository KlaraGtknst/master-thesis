...
\begin{itemize}
    ...
    \item The proposed \ac{llm}-based \imp{} method was evaluated against established \ac{av} techniques, namely Unmasking and PPMD across different scenarios (cf. \autoref{sec:results_trad_av} and \autoref{sec:results_llm_av}/ \ref{enum:rq3})
    \item We analysed how chunked paraphrases affect detector scores by varying the number of chunks and assessing detection performance (cf. \autoref{sec:results_chunks}).
...
In \autoref{chap:authorship_identification}, we provide background on \ac{av}, covering early approaches, \acl{sota} methods, stylometry, and practical applications. 
