...
\begin{itemize}
    ...
    \item Development of an \ac{llm}-based \impAppr{} extending the work of \citet{koppel_determining_2014} (cf.~\autoref{sec:impostor_generation}). 
...
\autoref{chap:authorship_identification} introduces the background of \ac{av}, including early approaches, \acl{sota} methods, stylometry, and applications. 
...
\autoref{chap:experimental_setup} outlines the experimental setup, and \autoref{chap:experimental_results} reports the results. 
