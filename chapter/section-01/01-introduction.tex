...
\begin{itemize}
    ...
    \item Quantitative comparison of paraphrasing approaches using metrics adapted from summarization and translation tasks (hereafter paraphrasing scores) (cf.~\Cref{sec:comp_paraphrases}/~\ref{enum:rq2}).
