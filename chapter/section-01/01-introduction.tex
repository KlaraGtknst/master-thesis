...
\begin{questions}
    ...
    We design an experiment comparing one-step %and advanced two-step \ac{llm} paraphrasing techniques 
    ...
    We test \ac{av} scenario with human authored text pairs. % and \ac{llm} detection
