...
\Cref{fig:sem_syn_blog} shows aggregated semantic and syntactic scores for the \dataBlog{} dataset, with detailed results in \Cref{fig:radar_blog} of the Appendix. 
Detailed and aggregated results for the \dataGutenberg{} dataset are provided in \Cref{fig:sem_syn_gutenberg} of the Appendix.
...
Results across datasets are summarised in \Cref{tab:extraction_eval_stats}, where $\diameter$ and $\sigma$ denote the mean and standard deviation across the five selected samples. 
