...
Semantic similarity $\diameter_{sem}$ was assessed using BERTScore, cosine similarity of BERT-based embeddings, and SBERT \ac{wmd}. 
...
\begin{table}[h]
\centering
\caption[Extraction effectiveness and length matching for different datasets.]{Extraction effectiveness and length matching for different datasets. Five documents per dataset were processed using the \pextractor{} to obtain genre, century, and topic.}
