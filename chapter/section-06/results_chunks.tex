...
\Cref{tab:impact_chunks_dataset_paraphraser} summarizes the effect of chunking on syntactic and semantic measures. 
...
Additional visualizations are provided in the Appendix (cf.~\Cref{sec:app_chunks}).
