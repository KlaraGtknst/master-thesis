...
Since we compute \ac{rouge} scores for individual reference–candidate pairs, the union of candidates in a pair containing only one candidate consists solely of that candidate. 
