...
In contrast to the original study, our \impAppr{} recall–precision curves intersect, indicating weaker separation between the approaches. 
Furthermore, whereas \citet{koppel_determining_2014} reported optimal performance at 50 \imps{}, our experiments on the \dataBlog{} dataset suggest that 500 \imps{} yield the best results. 
Although we are able to reproduce one recall–precision pair reported for 50 \imps{}, the pair corresponding to 500 \imps{} deviates from the original findings.

By contrast, our experiments on the \dataStudent{} dataset (cf. \autoref{app:exp_student_dif_n}) support the original conclusion that 50 \imps{} achieve superior performance, thereby highlighting a dataset-dependent effect.
...
% In our experiments, the number of \imps{} exerts minimal influence on precision and recall for the \dataStudent{} dataset.
% Nevertheless, similar to the original findings, we observe that using 50 \imps{} yields marginally superior performance.

\begin{figure}[htbp]
    \centering
    \includesvg[width=\textwidth]{images/imposter/reproduction_koppel_figures/fig2/blog/roc_prec_recall_curve_fixed_r100_top100000_dif_n_imp.svg}
