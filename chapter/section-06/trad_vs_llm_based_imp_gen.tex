...
Upon further investigation of the F1 score, we find that almost all baseline methods do not work at all and even experience an extreme drop of both precision and recall at certian threshold values.
