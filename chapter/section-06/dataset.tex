...
Due to this approach extending the original \impAppr{} by \citet{koppel_determining_2014}, 
...
Following \citet{koppel_determining_2014}, we use the first four assignments for our \impAppr{}. 
...
To extend our test scenario for the \impAppr{}, we opted to find additional datasets that 
...
\end{itemize}
In order to produce a controlled testing environment for our \impAppr{}, 
