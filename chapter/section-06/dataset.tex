...
Due to this approach extending the original impostor approach by \citet{koppel_determining_2014}, 
...
\autoref{subsec:original_data} outlines work on the original datasets.
\autoref{subsec:additional_data} describes supplementary the datasets \dataPan{} and \dataGutenberg{}.
After general description of the datasets, we present our preprocessing pipeline in \autoref{subsec:dataset_preprocessing}, and conclude with the pair selection process in \autoref{subsec:dataset_text_pair_selection}.
...
Following \citet{koppel_determining_2014}, we use the first four assignments for our impostor approach. 
...
For establishing a baseline in our impostor experiments, we use both the \dataBlog{} and \dataStudent{} datasets.


\subsection{Additional Data}
\label{subsec:additional_data}
To extend our test scenario for the impostor approach, we opted to find additional datasets that 
...
\end{itemize}
In order to produce a controlled testing environment for our impostor approach, 
