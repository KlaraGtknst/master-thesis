...
We want to answer the question of how our \ac{llm}-based \imp{} generation performs compared to (a) traditional \imp{} generation methods in the \impAppr{}~\citep{koppel_determining_2014}, and compared to (b) state-of-the-art \ac{av} methods in the traditional \ac{av} scenario.
...
The \impAppr{} and \unmasking{} detector configuration are shown in \Cref{tab:exp5_imp_config} and \Cref{tab:exp5_unmasking_config}, respectively.
