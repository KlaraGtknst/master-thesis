...
The cosine similarity between dense vector representations $v_a, v_b$ of two documents $a,b$ is computed in \autoref{eq:cosine_sim}~\citep{thongtan_cosine_sim_19}.
