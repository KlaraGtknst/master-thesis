...
This work is similar to our work in that it uses \acp{llm} to generate texts during inference.
We do not fine-tune an \ac{llm} for paraphrasing but use off-the-shelf models.
%%%% similarity measure
Both approaches compute the similarity of the original text and the generated text.
