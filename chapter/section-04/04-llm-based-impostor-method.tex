...
As discussed in \Cref{sec:contextual_factors}, these dimensions restrict linguistic options, thereby obscuring the stylometric features relevant for authorship-related tasks. 
To mitigate this issue, we extend the \impAppr{} originally proposed by \citet{koppel_determining_2014}.
As detailed in \Cref{sec:impostor_generation}, we intend to leverage \acp{llm} to control multiple confounders simultaneously.
