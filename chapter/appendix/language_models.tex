...
\begin{tabular}{@{}llrl@{}}
\toprule
\textbf{Organization} & \textbf{Model} & \textbf{Context Window Size (\# token)} & \textbf{Knowledge cut-off} \\
\midrule
...
It is a multilingual dense transformer-based \ac{llm} with 123B parameters\footnote{\url{https://huggingface.co/mistralai/Mistral-Large-Instruct-2407},\\ \url{https://dataloop.ai/library/model/alpindale_mistral-large-instruct-2407-fp8/} (14.09.2025); unlike the version at this URL, our model is full-precision.}.
