...
We used four autoregressive \acp{llm} for paraphrasing and instruction-based information extraction, with details in \Cref{tab:llm_paraphrasers} and the subsequent subsections.
