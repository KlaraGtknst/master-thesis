...
\begin{figure}[H]
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includesvg[width=0.9\linewidth]{images/imposter/reproduction_koppel_figures/fig4/student_essays/student_roc_prec_recall_curve_r100_top100000_Same_Author_dif_imp_gen.svg}
    \caption{Same author reference class}
    \label{fig:student_essays_same_author}
  \end{subfigure}
  \begin{subfigure}{\textwidth}
    \centering
    \includesvg[width=0.9\linewidth]{images/imposter/reproduction_koppel_figures/fig4/student_essays/student_roc_prec_recall_curve_r100_top100000_Different_Author_dif_imp_gen.svg}
