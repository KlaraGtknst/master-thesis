...
\begin{definition}
    ...
    In terms of machine learning, this is a multiclass, single-label text categorisation task 
...
\begin{definition}
    ...
    \citet{bevendorff_divergence_based_2020} explicitly states that the goal is to maximise the paraphrases' style difference to the refernce text.
\end{definition}
