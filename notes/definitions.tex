...
\begin{definition}
    ...
    in the model's output distribution \cite{mitchell_detectgpt_2023}.
\end{definition}

\begin{definition}
    [Nucleus sampling]
    Nucleus sampling is a text generation technique that selects the next token from the smallest set of tokens 
    whose combined probability exceeds $p$~\cite{mitchell_detectgpt_2023}.‚
\end{definition}
...
\begin{definition}
    ...
    i.e. $p(x_i | x_{<i})$~\cite{zhang_llmdet_2023}.
\end{definition}