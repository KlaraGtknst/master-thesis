...
The content of the while loop is, except the number of removed features (\cite{koppel_authorship_2004}: 6 total), 
similar to the original unmasking algorithm \cite{koppel_authorship_2004}.
