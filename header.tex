...
\usepackage{pgf}
\usepackage{tikz}
\usetikzlibrary{arrows,automata,decorations.pathmorphing,arrows.meta, positioning,shapes.misc, shapes.symbols}

\tikzset{
  block/.style = {draw, thick, minimum width=1.8cm, minimum height=1.2cm, align=center},
...
\newcommand{\impAppr}{Impostor approach}  % can or can not be capitalized
